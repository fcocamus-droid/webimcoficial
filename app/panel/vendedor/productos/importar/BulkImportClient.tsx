...
type ImportError = { rowNumber: number; titulo?: string; error: string }
...
export default function BulkImportClient({
  ...
  const handleUpload = async () => {
    if (!file) {
      setError('Selecciona un archivo (CSV o Excel) primero.')
      return
    }
    setLoading(true)
    setError(null)
  ...
  const downloadErrorReport = () => {
    ...
    downloadCSV(`errores-import-${today}.csv`, buildErrorCSV(importResult.errors))
  }
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 space-y-6">
          <div>
            ...
            <p className="text-sm text-slate-600">
              Un archivo CSV con las columnas correctas y dos filas de ejemplo.
              Ábrelo en <strong>Excel</strong> o <strong>Google Sheets</strong>,
              completa tus productos y guárdalo. Puedes subir el resultado como{' '}
              <strong>.csv</strong> o como <strong>.xlsx</strong>.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="/api/seller/products/bulk/export"
              download
              className="inline-flex items-center gap-2 bg-white border border-slate-300 hover:border-navy-600 hover:text-navy-700 text-slate-700 font-semibold px-5 py-2.5 rounded-lg"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
              </svg>
              Descargar mi catálogo actual
            </a>
          </div>
          <p className="text-xs text-slate-500 -mt-3">
            Tip: descarga tu catálogo, edítalo en Excel y vuelve a subirlo en
            modo <strong>Actualizar</strong> para cambiar precios o stock de
            todos tus productos de una vez.
          </p>
          ...
          <div className="border-t border-slate-200 pt-6 space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex gap-2">
                ...
                <span>
                  <strong>Máximo 500 productos</strong> por archivo. Si tienes
              ...
              <li className="flex gap-2">
                <span className="text-verified-600 font-bold">✓</span>
                <span>
                  Aceptamos <strong>.csv</strong> y <strong>.xlsx</strong>{' '}
                  (Excel).
                </span>
              </li>
              <li className="flex gap-2">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <code className="bg-slate-100 px-1 rounded">DISPONIBLE</code>,{' '}
                  <code className="bg-slate-100 px-1 rounded">A_PEDIDO</code> o{' '}
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <code className="bg-slate-100 px-1 rounded">CHILE</code>,{' '}
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  es el precio sin IVA. Déjalo vacío para mostrar “a cotizar”.
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-verified-600 font-bold">✓</span>
              ...
              <li className="flex gap-2 bg-amber-50 border border-amber-200 rounded p-2">
                <span className="text-amber-700 font-bold">★</span>
                <span className="text-amber-900">
                  <strong>Imágenes:</strong> columnas{' '}
                  <code className="bg-amber-100 px-1 rounded">imagen_1</code>,{' '}
                  <code className="bg-amber-100 px-1 rounded">imagen_2</code>,{' '}
                  <code className="bg-amber-100 px-1 rounded">imagen_3</code>{' '}
                  aceptan URLs públicas (https://…). Las descargamos por ti al
                  importar. Cada una debe ser JPG/PNG/WEBP y pesar &lt; 5MB.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
          {!preview && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 space-y-5">
              ...
              <label className="block">
                <span className="label-base">Archivo</span>
                <input
                  ref={fileInputRef}
                  type="file"
          ...
          {preview && (
            <div className="space-y-4">
              ...
              {/* Modo create vs upsert */}
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                <h4 className="font-semibold text-slate-900 mb-3">
                  ¿Qué hacer con productos que ya existen?
                </h4>
                <div className="grid sm:grid-cols-2 gap-3">
                  <label
                    className={`relative flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition ${
                      mode === 'create'
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">
                        Cada fila se crea como un producto nuevo, incluso si el
                        SKU ya existe en tu catálogo.
                      </p>
                    </div>
                  </label>
                  <label
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-slate-900">
                        Actualizar si el SKU existe
                      </p>
                      <p className="text-xs text-slate-600 mt-1">
                        Si la fila tiene un SKU que ya está en tu catálogo,
                        actualizo ese producto en vez de duplicarlo.{' '}
                        {preview.upsertCount > 0 && (
                          <strong className="text-navy-700">
                            {preview.upsertCount} fila
                            {preview.upsertCount === 1 ? '' : 's'} coincide
                            {preview.upsertCount === 1 ? '' : 'n'} con SKUs
                            existentes.
                          </strong>
                        )}
                      </p>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="px-5 py-3 border-b border-slate-200 flex items-center justify-between flex-wrap gap-2">
                  ...
                  <p className="text-xs text-slate-500">
                    Solo se procesarán las filas marcadas con ✓
                  </p>
                </div>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-slate-50 sticky top-0">
                      <tr className="text-left text-xs uppercase tracking-wider text-slate-500">
                        ...
                        <th className="px-4 py-2 text-center">Imgs</th>
                              ...
                              <span className="font-mono text-slate-700">
                                ...
                                {r.skuExists && (
                                  <span
                                    ...
                                    title="Este SKU ya existe en tu catálogo"
                                  >
                                    ↻
                                  </span>
                                )}
              ...
              {preview.invalidCount > 0 && (
                <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-3 text-sm text-amber-800">
                  ...
                  continúas, solo se procesarán las {preview.validCount} filas
                  válidas. Puedes corregir el archivo y volver a subirlo si
                  prefieres importar todo de una vez.
                </div>
              )}

              {preview.totalImages > 0 && (
                <div className="rounded-lg bg-blue-50 border border-blue-200 px-4 py-3 text-sm text-blue-800">
                  <strong>Imágenes:</strong> vamos a descargar{' '}
                  {preview.totalImages} imagen
                  {preview.totalImages === 1 ? '' : 'es'} desde las URLs
                  indicadas. Esto puede tomar entre 5 y 60 segundos según el
                  tamaño y la velocidad de los servidores de origen.
                </div>
              )}
                ...
                >
                  {loading ? (
                    <span className="flex items-center gap-2">
                      ...
                      Procesando productos e imágenes…
                    </span>
                  ) : (
                    `Procesar ${preview.validCount} producto${
        ...
        <div className="space-y-5">
          <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 text-left">
              <div className="bg-verified-50 rounded-xl p-4">
                <p className="text-3xl font-bold text-verified-700">
                  {importResult.created}
                </p>
                <p className="text-xs uppercase tracking-wider text-verified-700 mt-1">
                  Creados
                </p>
              </div>
              <div className="bg-navy-50 rounded-xl p-4">
                ...
                <p className="text-xs uppercase tracking-wider text-navy-700 mt-1">
                  Actualizados
                </p>
              </div>
          ...
          {importResult.errors.length > 0 && (
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              <div className="px-5 py-3 border-b border-slate-200 flex items-center justify-between flex-wrap gap-2">
                <h4 className="font-semibold text-slate-900">
                  Filas / imágenes con problemas ({importResult.errors.length})
                </h4>
                <button
                  type="button"
                  onClick={downloadErrorReport}
                  className="text-xs bg-white border border-slate-300 hover:border-navy-600 hover:text-navy-700 text-slate-700 font-semibold px-3 py-1.5 rounded-lg inline-flex items-center gap-1.5"
                >
                  <svg
